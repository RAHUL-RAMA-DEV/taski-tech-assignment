...
10.create a test file in test folder and run test tool commands          //run commands like supertest ,jest,eslint to check unit test,integration test and static code analysis////
